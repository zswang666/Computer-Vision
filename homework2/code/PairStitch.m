...
for i = 1 : length(Transformation),
    T = maketform('projective', Transformation{i}');
...
Pano = imtransform( im2double(img2), maketform('projective', eye(3)), 'bilinear', ...
                    'XData', XdataLimit, 'YData', YdataLimit, ...
                    'FillValues', NaN, 'XYScale', 1);

AddOn = imtransform(im2double(img1), maketform('projective', H'), 'bilinear', ...
                    'XData', XdataLimit, 'YData', YdataLimit, ...
                    'FillValues', NaN, 'XYScale', 1);
